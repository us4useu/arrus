...
void Us4OEMImpl::setMaximumPulseLength(std::optional<float> maxLength) {
    ...
    TxLimitsBuilder txBuilder{this->descriptor.getTxRxSequenceLimits().getTxRx().getTxHV0()};
    ...
    seqBuilder.setTxRxLimits(txLimits, descriptor.getTxRxSequenceLimits().getTxRx().getTxHV1(), descriptor.getTxRxSequenceLimits().getTxRx().getRx(),
