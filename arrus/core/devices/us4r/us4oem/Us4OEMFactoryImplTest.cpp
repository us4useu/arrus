...
TEST(Us4OEMFactoryTest, SetsAppropriateTxRxLimits) {
    ...
    EXPECT_EQ(txRxLimits0.getTxHV1().getPulseLength(), pulseLengthLimits);
    EXPECT_EQ(txRxLimits0.getTxHV1().getVoltage(), voltageLimits);
    ...
    EXPECT_EQ(txRxLimits1.getTxHV1().getPulseCycles(),  Interval<float>(0.5f, 32.0f)); // Us4OEMFactoryImpl default
    EXPECT_EQ(txRxLimits1.getTxHV1().getVoltage(), voltageLimits);
    ...
    EXPECT_EQ(txRxLimits2.getTxHV1().getPulseLength(),  pulseLengthLimits);
    EXPECT_EQ(txRxLimits2.getTxHV1().getVoltage(), Interval<Voltage>(5, 90)); // Us4OEMFactoryImpl default value
    ...
    EXPECT_EQ(txRxLimits3.getTxHV1().getPulseLength(),  pulseLengthLimits);
    EXPECT_EQ(txRxLimits3.getTxHV1().getVoltage(), voltageLimits);
}
}
