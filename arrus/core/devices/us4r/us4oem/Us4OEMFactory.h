...
public:
    ...
    getUs4OEM(Ordinal ordinal, IUs4OEMHandle &handle, const Us4OEMSettings &settings,
              bool acceptRxNops = false, const std::optional<Us4RTxRxLimits> &limits = std::nullopt) = 0;
