...
public:
    ...
    ::us4r::afe58jd48::LNA_GAIN_GBL getEnumValue(const ValueType value) {
...
private:
    std::unordered_map<ValueType, ::us4r::afe58jd48::LNA_GAIN_GBL> valueMap;

    LNAGainValueMap() {
        valueMap.emplace(ValueType(18),
                         ::us4r::afe58jd48::LNA_GAIN_GBL::LNA_GAIN_GBL_18dB);
        valueMap.emplace(ValueType(21),
                         ::us4r::afe58jd48::LNA_GAIN_GBL::LNA_GAIN_GBL_21dB);
        valueMap.emplace(ValueType(15),
                         ::us4r::afe58jd48::LNA_GAIN_GBL::LNA_GAIN_GBL_15dB);
    }
