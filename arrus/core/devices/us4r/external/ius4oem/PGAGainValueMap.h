...
public:
    ...
    ::us4r::afe58jd48::PGA_GAIN getEnumValue(const ValueType value) {
...
private:
    std::unordered_map<ValueType, ::us4r::afe58jd48::PGA_GAIN> valueMap;

    PGAGainValueMap() {
        valueMap.emplace(ValueType(24), ::us4r::afe58jd48::PGA_GAIN::PGA_GAIN_24dB);
        valueMap.emplace(ValueType(21), ::us4r::afe58jd48::PGA_GAIN::PGA_GAIN_21dB);
        valueMap.emplace(ValueType(27), ::us4r::afe58jd48::PGA_GAIN::PGA_GAIN_27dB);
        valueMap.emplace(ValueType(18), ::us4r::afe58jd48::PGA_GAIN::PGA_GAIN_18dB);
    }
