...
public:
    ...
    void checkVoltage(Voltage voltageMinus, Voltage voltagePlus, float tolerance, int retries, bool isUS4PSC, bool isHVPS);
...
private:
    ...
    std::vector<VoltageLogbook> logVoltages(bool isHV256, bool isHVPS);
