...
class SettingsDictionary {
    ...
    getAdapterSettings(const ProbeAdapterModelId &adapterModelId) const {
        ...
        try {
            ...
            throw IllegalArgumentException("Adapter model not found: {}", idStr);
        }
    }
    ...
    getProbeSettings(const ProbeModelId &probeModelId,
        ...
        try {
            ...
            throw IllegalArgumentException("There is no defined setting in the dictionary "
                                           "for pair: ({}, {}), ({}, {})",
    ...
    [[nodiscard]] ProbeModel getProbeModel(const ProbeModelId &id) const {
        ...
        try {
            ...
            throw IllegalArgumentException("Probe model not found: {}", idStr);
        }
    }
