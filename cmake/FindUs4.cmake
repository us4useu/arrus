...
find_library(Us4_Us4RDBAR_LIBRARY
    NAMES Us4RDBAR
    PATHS ${Us4_LIBRARY_DIR}
    NO_CMAKE_ENVIRONMENT_PATH
    NO_SYSTEM_ENVIRONMENT_PATH
...
if(Us4_FOUND AND NOT TARGET Us4::Us4RPSC)
    add_library(Us4::Us4RPSC UNKNOWN IMPORTED)
    set_target_properties(Us4::Us4RPSC PROPERTIES
        IMPORTED_LOCATION "${Us4_Us4RPSC_LIBRARY}"
        INTERFACE_COMPILE_OPTIONS "${PC_Us4_CFLAGS_OTHER}"
        INTERFACE_INCLUDE_DIRECTORIES "${Us4_INCLUDE_DIR}"
        )
endif()

if(Us4_FOUND AND NOT TARGET Us4::Us4RDBAR)
    add_library(Us4::Us4RDBAR UNKNOWN IMPORTED)
    set_target_properties(Us4::Us4RDBAR PROPERTIES
        IMPORTED_LOCATION "${Us4_Us4RDBAR_LIBRARY}"
        INTERFACE_COMPILE_OPTIONS "${PC_Us4_CFLAGS_OTHER}"
        INTERFACE_INCLUDE_DIRECTORIES "${Us4_INCLUDE_DIR}"
        )
endif()
