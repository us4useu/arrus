# Based on FindMatlab.cmake from cmake 3.22.1.
# Main change: during Matlab version discovery, use VersionInfo.xml file instead
# of running Matlab instance.
#
...
:variable:`MATLAB_ADDITIONAL_VERSIONS`
  ...
  versions.
:variable: MATLAB_USE_VERSION_INFO_FILE
  whether VersionInfo.xml should be used instead of reading the version by
  running Matlab instance
...
function(_Matlab_get_version_from_root matlab_root matlab_or_mcr matlab_known_version matlab_final_version)
    ...
    if((matlab_or_mcr STREQUAL "MATLAB" OR matlab_or_mcr STREQUAL "UNKNOWN") AND NOT (DEFINED MATLAB_USE_VERSION_INFO_FILE AND NOT "${MATLAB_USE_VERSION_INFO_FILE}" STREQUAL ""))
        # MATLAB versions
    ...
    elseif(EXISTS "${matlab_root}/VersionInfo.xml")
        ...
        set(Matlab_VERSION_STRING_INTERNAL
                "${_matlab_version_tmp}"
                CACHE INTERNAL "Matlab (or MCR) version (automatically determined)"
                FORCE)
    endif() # Matlab or MCR
