...
swig -c++ -python -I"$ARIUS_PATH\Arius\include" -I"$ARIUS_PATH\include" -I"." -outdir arius\python\devices\ arius\core\iarius.i
cl.exe /I"$ARIUS_PY_PATH\include" /I"$ARIUS_PATH\include" /I"$ARIUS_PATH\Arius\include" /I"." /Od /LD /EHsc arius\core\iarius_wrap.cxx "$ARIUS_PY_PATH\libs\*.lib" "$ARIUS_BIN_PATH\Arius.lib" /oarius\python\devices\_iarius.pyd
