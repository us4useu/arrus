classdef DigitalDownConversion
    ...
    % :param firCoefficients: coefficients of the FIR filter to apply, \
    %     only the upper half has to be provided (filter must be symmetric).
    % :param gain: an extra digital gain to apply (after decimation filter), \
    %     by default set to 12 dB. Currently only 0 and 12 dB are supported. [dB]
    ...
    properties
        ...
        gain (1, 1) {mustBeFinite, mustBeReal, mustBePositive} = 12
    end
    methods
