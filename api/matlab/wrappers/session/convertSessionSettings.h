...
#include "api/matlab/wrappers/devices/us4r/convertUs4RSettings.h"
#include "arrus/core/api/session/SessionSettings.h"
#include "mex.hpp"

namespace arrus::matlab {
arrus::session::SessionSettings convertToSessionSettings(const MexContext::SharedHandle &ctx,
                                                         const ::matlab::data::Array &object) {
    auto matlabEngine = ctx->getMatlabEngine();
    // us4RSettings
    ::matlab::data::Array us4rSettingsObj = matlabEngine->getProperty(object, "us4RSettings");
    ::arrus::devices::Us4RSettings us4RSettings = convertToUs4RSettings(ctx, us4rSettingsObj);
